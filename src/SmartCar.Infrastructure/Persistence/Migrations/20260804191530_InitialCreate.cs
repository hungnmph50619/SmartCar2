        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CustomerDocuments_AspNetUsers_CustomerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdditionalAmount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    VehicleHandoverId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BookingId = table.Column<int>(type: "int", nullable: false),
                    HandoverAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Mileage = table.Column<int>(type: "int", nullable: false),
                    FuelLevel = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    ExteriorCondition = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    InteriorCondition = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VehicleHandovers", x => x.VehicleHandoverId);
                    table.ForeignKey(
                        name: "FK_VehicleHandovers_Bookings_BookingId",
                        column: x => x.BookingId,
                        principalTable: "Bookings",
                        principalColumn: "BookingId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VehicleReturns", x => x.VehicleReturnId);
                    table.ForeignKey(
                        name: "FK_VehicleReturns_Bookings_BookingId",
                        column: x => x.BookingId,
                        principalTable: "Bookings",
                        principalColumn: "BookingId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AdditionalCharges_VehicleReturns_VehicleReturnId",
                        column: x => x.VehicleReturnId,
                        principalTable: "VehicleReturns",
                        principalColumn: "VehicleReturnId",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateIndex(
                name: "IX_AdditionalCharges_VehicleReturnId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_VehicleId_PickupDate_ReturnDate_Status",
                table: "Bookings",
                columns: new[] { "VehicleId", "PickupDate", "ReturnDate", "Status" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VehicleHandovers_BookingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VehicleReturns_BookingId",
